...
function generarPresupuestoBackend(form) {
  ...
  try {
    ...
    wsAtenciones.appendRow([
      ...
      fechaHoy,           // 2. FECHA
      runPaciente,        // 3. RUN
      form.nombre,        // 4. NOMBRE
      form.convenio,      // 5. CONVENIO
      form.tipoAtencion,  // 6. ATENCIÓN
      "PENDIENTE PAGO",   // 7. ESTADO
      "",                 // 8. LINK ENTREGA
      url,                // 9. LINK COBRO (Presupuesto)
      "",                 // 10. LINK FIRMADO (Espacio en blanco reservado)
      "",                 // 11. NRO CRI
      form.usuario        // 12. USUARIO
    ]);
  ...
  try {
    ...
    if (form.idAtencionPrevio) {
      ...
      wsAtenciones.appendRow([
        ...
        form.tipoAtencion,  // 6. ATENCIÓN
        "ENTREGADO",        // 7. ESTADO
        urlPDF,             // 8. LINK ENTREGA (Si es Hosp, va vacío)
        "",                 // 9. LINK COBRO
        "",                 // 10. LINK FIRMADO (NUEVO - Espacio en blanco reservado)
        "",                 // 11. NRO CRI
        form.usuario        // 12. USUARIO
      ]);
