...
/**
 * Convierte el logo de Drive a Base64 forzando el formato JPEG.
 */
function getLogoBase64() {
  try {
    const file = DriveApp.getFileById(CONFIG.ID_LOGO);
    // getAs(MimeType.JPEG) obliga al sistema a tratarlo como foto pura
    const blob = file.getBlob().getAs(MimeType.JPEG); 
